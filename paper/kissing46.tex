...
bound in $52$ dimensions between $25$ and $96$. All but four of these bounds
...
$K(71)\ge\Kh{71}$, $K(70)\ge\Kh{70}$,
$K(69)\ge\Kh{69}$ and $K(68)\ge\Kh{68}$. In dimensions $46$ and
...
$\R^{n}\oplus\R^{k}$ and adjoins lifted copies of part of it. Its level $t$ is
bounded below by $1/(2(1-\gamma))$, where $\gamma$ is the largest inner product
allowed between two minimal lines lifted above one direction: for $\Leech$ and
$\Gsz$ the level may be $\tfrac23$, where one set of lines serves a zero-sum
triple of directions, while $\Pff$ admits only an antipodal pair. This gives
$K(38)\ge\Kh{38}$ and improvements throughout $49\le n\le 61$ and
$73\le n\le 95$; over $\Leech$ it reproduces the published values in dimensions
$25$ to $31$ to within $496$, and rebuilding its caps --- as heads in the lens of
a minimal vector, and as coset classes over norm-$6$ vectors on every triangle of
directions --- gives $K(25)\ge\Kh{25}$, $K(26)\ge\Kh{26}$ and
$K(27)\ge\Kh{27}$. The level is forced only for a layer that carries a whole set
of lines; one carrying a few points above each direction may sit at any height,
and there are heights at which such a layer deletes nothing at all and its
directions still clear the axis. The norm of its head is free as well, and at
height $\sqrt2$ a norm-$8$ head --- rather than the norm-$6$ one every earlier
layer used --- lets a whole frame of $\Leech$ carry the whole cross-polytope of
$\R^{k}$, which is $96k$ points in every dimension and deletes nothing. This
gives $K(28)\ge\Kh{28}$, $K(29)\ge\Kh{29}$, $K(30)\ge\Kh{30}$ and
$K(31)\ge\Kh{31}$, so that every dimension from $25$ to $31$ is improved.

The four remaining bounds are code-theoretic. Evaluated against the current code
tables, the chain of Edel--Rains--Sloane gives $K(39)\ge\Kh{39}$,
$K(62)\ge\Kh{62}$ and $K(63)\ge\Kh{63}$; at $n=96$ it overtakes
$\Gsz$, giving $K(96)\ge\Kh{96}$.
...
the fifty-two improvements below lie in these ranges.
...
\begin{table}[ht]
\caption{The fifty-two improvements, grouped by construction; $\#$ is the number
...
$2026$. The rows
with factors near $1$ span the most dimensions, $45$ of the $52$, though the two
...
\emph{The fifty-two listed below.} We have found no earlier published claim in dimensions
$25$--$31$, $38$, $39$, $49$--$63$, $68$--$71$ or $73$--$96$. The one-point
...
Forty-three of the fifty-two dimensions below lie in ranges in which the published
...
\caption{All fifty-two improvements. ``Previously'' is \cite{cohn-table} where
