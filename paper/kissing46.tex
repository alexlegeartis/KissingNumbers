...
free heads that remove nothing. Optimising the class heads, the free heads and the second
cap layer \emph{together} rather than one after another --- which is B.~Lindow's
contribution --- gives $2095$ class heads and $164$ free heads, against $2133$ and $129$
for the same three chosen in sequence.  Both dimensions carry a second cap layer, at $|x|^{2}=3$ with $|y|=1$;
...
to $3110$; $299$ of them fit, $103+98+98$.  Everything reduces to
...
other. Dimension $27$ fails although the sharing is high. Its next admissible
