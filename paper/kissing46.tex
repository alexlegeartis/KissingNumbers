...
bound in $48$ dimensions between $25$ and $96$. All but four of these bounds
...
the forty-eight improvements below lie in these ranges.
...
\begin{table}[ht]
\caption{The forty-eight improvements, grouped by construction; $\#$ is the number
...
$2026$. The rows
with factors near $1$ span the most dimensions, $41$ of the $48$, though the two
...
\emph{The forty-eight listed below.} We have found no earlier published claim in dimensions
...
Forty-three of the forty-eight dimensions below lie in ranges in which the published
...
\caption{All forty-eight improvements. ``Previously'' is \cite{cohn-table} where
...
\item \emph{Configurations small enough to write down are checked in
      ...
      head--axis inequalities in $\mathbb{Q}(\sqrt2,\sqrt3)$.
...
in the same way, inside the joint work with H.~Cohn and B.~Lindow. The agent proposed constructions, implemented and ran the verification
