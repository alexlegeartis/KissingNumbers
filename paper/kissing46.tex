...
$1.98\times10^5$ and $1.29\times10^{10}$ points. A lattice together with a few
...
gives $K(25)\ge\Kh{25}$, verified in exact arithmetic by the package
...
triangle $v_1,v_2,v_3$; its $96$ free heads are given up for the second layer of
\Sef{sec:secondlayer}, which they alone were blocking, and
...
$129$ free heads.  Dimension $27$ also carries a SECOND cap layer, at $|x|^{2}=3$ with
$|y|=1$, which dimension $26$ has no room for.  Such a cap satisfies $\ip{y}{a}\le2$
whatever direction it points, since $|y||a|=2$; it carries the antipodal pair $\pm y$ and
no more, three directions needing pairwise cosine $\le-1$; and the scaled owner
$x=\tfrac{\sqrt3}{2}u$ deletes exactly $u$, because $\ip{x}{z}>2$ forces
...
layer pays as soon as the $42$ type-$B$ classes hold at least $10\,252$ of the
