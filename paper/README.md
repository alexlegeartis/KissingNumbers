...
through 96*. 42 pages, `amsart`, no packages beyond `amssymb`, `amsmath`, `booktabs`,
...
to confirm it; the build is 42 pages with no warnings.
...
`factcheck.py` (725 checks) does not parse the repository's conclusions, it **re-derives**
