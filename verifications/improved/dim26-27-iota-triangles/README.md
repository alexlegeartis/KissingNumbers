...
**τ(26) ≥ 199 770** and **τ(27) ≥ 201 492**, against the published 198 550 and 200 044
...
Improvements of **+1 220** and **+1 448** over the table.
...
|---|---|---|
| equator `(z, 0)`, `z` a minimal vector that is not an owner | 195 102 | 194 160 |
| caps, three per head | 3 × 1554 | 3 × 2262 |
| caps, two per second-layer head (dimension 27 only) | — | 2 × 267 |
| axis | 6 | 12 |
| **total** | **199 770** | **201 492** |
...
owners from 0 to **3009**, and 267 of them fit (87 + 90 + 90). Everything reduces to two
integer comparisons,
