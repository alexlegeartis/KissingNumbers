...
rebuilt: 1016 heads of squared length 3 in the lens of a minimal vector, each removing
exactly its owner, plus one non-lattice equator point. Better by +521. The level argument
