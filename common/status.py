...
REASON = {
    ...
    'exhausted-27': 'the cuboctahedron pins the twelve directions, four zero-sum triangles pairwise at '
                    ...
                    'in an hour.  The eight zero-sum triples of the cuboctahedron give nothing over '
                    ...
                    'across lines, so at most three times an independence number measured at 95: '
                    'ceiling 285, not the 1078 CP-SAT reported, and 278 of it is now taken (was 267). '
